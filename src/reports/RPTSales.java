...
public class RPTSales {
    ...
    public void reportSales(String dateStart, String dateEnd) {
        ...
        try {
            FileOutputStream fileOutputStream = new FileOutputStream(env.URL_SERVER_FILES + "reportes/RPT VENTAS " + todaysDate + ".pdf");
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    if (contadorHeader <= 1) {
                        ...
                        PdfPCell tipoComprobante = new PdfPCell(new Phrase("REPORTE DE VENTAS", fuenteDescripcionTablasBOLD));
            ...
            float[] medidatablaVentas = {20f, 20f, 7f, 10f, 10f, 10f, 13f, 10f};
            table.setWidths(medidatablaVentas);

            PdfPCell customer = new PdfPCell(new Phrase("Clientes", tituloTablaBOLD));
            ...
            PdfPCell typePayment = new PdfPCell(new Phrase("Tipo de pago", tituloTablaBOLD));
            typePayment.setHorizontalAlignment(Element.ALIGN_LEFT);
            typePayment.setVerticalAlignment(Element.ALIGN_MIDDLE);
            typePayment.setMinimumHeight(25);
            typePayment.setBorder(0);
            typePayment.setBorderWidthTop(1);
            typePayment.setBorderWidthBottom(1);
            typePayment.setBorderColor(BaseColor.GRAY);

            PdfPCell dateEmit = new PdfPCell(new Phrase("Emision", tituloTablaBOLD));
            ...
            PdfPCell state = new PdfPCell(new Phrase("Estado", tituloTablaBOLD));
            state.setHorizontalAlignment(Element.ALIGN_LEFT);
            state.setVerticalAlignment(Element.ALIGN_MIDDLE);
            state.setMinimumHeight(25);
            state.setBorder(0);
            state.setBorderWidthTop(1);
            state.setBorderWidthBottom(1);
            state.setBorderWidthRight(1);
            state.setBorderColor(BaseColor.GRAY);
            ...
            table.addCell(total);
            table.addCell(typePayment);
            table.addCell(dateEmit);
            table.addCell(state);

            CurrencyFormat currencys = new CurrencyFormat();
            String query = "SELECT c.full_name,CONCAT(cv.voucher,' ',v.serie, '-', v.number_voucher) AS voucherSales, "
            ...
            try {
                ...
                while (rs.next()) {
                    PdfPCell customerData = new PdfPCell(new Phrase(rs.getString("c.full_name"), fuenteDescripcionTablas));
                    ...
                    PdfPCell voucherData = new PdfPCell(new Phrase(rs.getString("voucherSales"), fuenteDescripcionTablas));
                    ...
                    PdfPCell igvData = new PdfPCell(new Phrase(currencys.formatCurrency(Double.parseDouble(rs.getString("v.igv"))).substring(1), fuenteDescripcionTablas));
                    ...
                    PdfPCell subTotalData = new PdfPCell(new Phrase(currencys.formatCurrency(Double.parseDouble(rs.getString("v.subtotal"))).substring(1), fuenteDescripcionTablas));
                    ...
                    PdfPCell totalData = new PdfPCell(new Phrase(currencys.formatCurrency(Double.parseDouble(rs.getString("v.total"))).substring(1), fuenteDescripcionTablas));
                    ...
                    PdfPCell typePaymentData = new PdfPCell(new Phrase(rs.getString("v.type_payment"), fuenteDescripcionTablas));
                    typePaymentData.setHorizontalAlignment(Element.ALIGN_LEFT);
                    typePaymentData.setVerticalAlignment(Element.ALIGN_MIDDLE);
                    typePaymentData.setMinimumHeight(15);
                    typePaymentData.setBorderWidthTop(0);
                    typePaymentData.setBorderWidthLeft(0);
                    typePaymentData.setBorderColor(BaseColor.LIGHT_GRAY);
                    ...
                    PdfPCell stateData = new PdfPCell(new Phrase(rs.getString("v.state"), fuenteDescripcionTablas));
                    stateData.setHorizontalAlignment(Element.ALIGN_LEFT);
                    stateData.setVerticalAlignment(Element.ALIGN_MIDDLE);
                    stateData.setMinimumHeight(15);
                    stateData.setBorderWidthTop(0);
                    stateData.setBorderWidthLeft(0);
                    stateData.setBorderColor(BaseColor.LIGHT_GRAY);
                    ...
                    table.addCell(typePaymentData);
                    table.addCell(dateEmitData);
                    table.addCell(stateData);
                }
            ...
            File file = new File(env.URL_SERVER_FILES + "reportes/RPT VENTAS " + todaysDate + ".pdf");
