...
public class RPTSupplier {
    ...
    public void reportSupplier() {
        ...
        try {
            FileOutputStream fileOutputStream = new FileOutputStream(env.URL_SERVER_FILES + "reportes/RPT PROVEEDORES " + todaysDate + ".pdf");
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    if (contadorHeader <= 1) {
                        ...
                        PdfPCell tipoComprobante = new PdfPCell(new Phrase("REPORTE DE PROVEEDORES", fuenteDescripcionTablasBOLD));
            ...
            PdfPCell customer = new PdfPCell(new Phrase("Razón social", tituloTablaBOLD));
            ...
            PdfPCell contact = new PdfPCell(new Phrase("Contactos", tituloTablaBOLD));
            contact.setHorizontalAlignment(Element.ALIGN_LEFT);
            contact.setVerticalAlignment(Element.ALIGN_MIDDLE);
            contact.setMinimumHeight(25);
            contact.setBorder(0);
            contact.setBorderWidthTop(1);
            contact.setBorderWidthBottom(1);
            contact.setBorderColor(BaseColor.GRAY);
            ...
            PdfPCell numberDocument = new PdfPCell(new Phrase("RUC", tituloTablaBOLD));
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    PdfPCell contactData = new PdfPCell(new Phrase(rs.getString("cellphone"), fuenteDescripcionTablas));
                    contactData.setHorizontalAlignment(Element.ALIGN_LEFT);
                    contactData.setVerticalAlignment(Element.ALIGN_MIDDLE);
                    contactData.setMinimumHeight(15);
                    contactData.setBorderWidthTop(0);
                    contactData.setBorderWidthLeft(0);
                    contactData.setBorderColor(BaseColor.LIGHT_GRAY);
                    ...
                    PdfPCell numberDocumentData = new PdfPCell(new Phrase(rs.getString("ruc"), fuenteDescripcionTablas));
            ...
            File file = new File(env.URL_SERVER_FILES + "reportes/RPT PROVEEDORES " + todaysDate + ".pdf");
