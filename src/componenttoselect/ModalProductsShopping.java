...
public class ModalProductsShopping extends javax.swing.JFrame {

    public static String pShopping = "0";
    public static String pSales = "0";
    public static String pQuantity = "0";
    public static String utility = "0";

    public ModalProductsShopping() {
        initComponents();
    ...
    void getSupplier(String search) {
        ...
        try {
            model = cProducts.getProductsModalShopping(search);
            ...
            listProducts.getColumnModel().getColumn(5).setMaxWidth(0);
            listProducts.getColumnModel().getColumn(5).setMinWidth(0);
            listProducts.getColumnModel().getColumn(5).setPreferredWidth(0);
    ...
    void calculateTotal() {
        ...
        for (int i = 0; i < WindowShopping.listProducts.getRowCount(); i++) {
             total +=  Double.parseDouble(WindowShopping.listProducts.getValueAt(i, 5).toString());
        }
        subTotal = total / 1.18;
        igv = subTotal * 0.18;
        WindowShopping.lblTotal.setText(String.valueOf(Math.round(total * 100) / 100d));
        WindowShopping.lblSubTotal.setText(String.valueOf(Math.round(subTotal * 100)/100d));
        WindowShopping.lblIGV.setText(String.valueOf(Math.round(igv * 100)/100d));
    }
    ...
    private void listProductsMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_listProductsMousePressed
        if (evt.getClickCount() == 2) {
            ...
            String[] data = new String[WindowShopping.headers.length];

            data[0] = listProducts.getValueAt(fila, 0).toString();
            data[1] = listProducts.getValueAt(fila, 2).toString();

            componentsregistry.QuantitySHopping.pShooping = listProducts.getValueAt(fila, 4).toString();
            componentsregistry.QuantitySHopping.pSales = listProducts.getValueAt(fila, 5).toString();
            componentsregistry.QuantitySHopping.utility = listProducts.getValueAt(fila, 6).toString();
            new componentsregistry.QuantitySHopping(null, true).setVisible(true);
            ...
            data[3] = pSales;
            data[4] = pQuantity;
            data[5] = String.valueOf(Double.parseDouble(pQuantity) * Double.parseDouble(pShopping));
            data[6] = utility;
            
            WindowShopping.modelTable.addRow(data);
            calculateTotal();
            pShopping = "0";
            pSales = "0";
            pQuantity = "0";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModalProductsShopping.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModalProductsShopping().setVisible(true);
            }
        });
    }
