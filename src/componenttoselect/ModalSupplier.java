...
public class ModalSupplier extends javax.swing.JFrame {
    ...
    void getSupplier(String search) {
        ...
        try {
            model = cSupplier.getSupplierModal(search);
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(28, 60, 84), 4, true));
        ...
        listSupplier.setFont(new java.awt.Font("Dialog", 1, 12)); // NOI18N
        listSupplier.setFuenteFilas(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        listSupplier.setFuenteHead(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        ...
        txtSearch.setPlaceholder("Buscar proveedor");
    ...
    private void listSupplierMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_listSupplierMousePressed
        if (evt.getClickCount() == 2) {
            ...
            WindowShopping.idUpdateData.setText(listSupplier.getValueAt(fila,0).toString());
            WindowShopping.txtNameSupplier.setText(listSupplier.getValueAt(fila,1).toString());
            this.dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModalSupplier.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModalSupplier().setVisible(true);
            }
        });
    }
