...
import controller.ControllerReportSales;
...
public class WindowRPTSales extends javax.swing.JPanel {

    Calendar cal, cal2;
    int d, m, a, dd, mm, aa;

    public WindowRPTSales() {
        initComponents();
    ...
    void getSales() {
        ControllerReportSales cReport = new ControllerReportSales();
        try {
            ...
            model = cReport.getSales(String.valueOf(new Date(a, m, d)), String.valueOf(new Date(aa, mm, dd)));
