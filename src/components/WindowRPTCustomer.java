...
import controller.ControllerReportCustomer;
...
import reports.RPTCustomer;

public class WindowRPTCustomer extends javax.swing.JPanel {

    Calendar cal, cal2;
    int d, m, a, dd, mm, aa;

    public WindowRPTCustomer() {
        initComponents();
    ...
    void getCustomer() {
        ControllerReportCustomer cReport = new ControllerReportCustomer();
        try {
            DefaultTableModel model;
            model = cReport.getCustomer();
    ...
    void report() {
        try {
            RPTCustomer export = new RPTCustomer();
            export.reportCustomer();
            ConnectionDB c = new ConnectionDB();
            c.closeConection();
        } catch (SQLException e) {
