...
import controller.ControllerReportSupplier;
...
import reports.RPTSupplier;

public class WindowRPTSupplier extends javax.swing.JPanel {

    Calendar cal, cal2;
    int d, m, a, dd, mm, aa;

    public WindowRPTSupplier() {
        initComponents();
    ...
    void getSupplier() {
        ControllerReportSupplier cReport = new ControllerReportSupplier();
        try {
            DefaultTableModel model;
            model = cReport.getSupplier();
    ...
    void report() {
        try {
            RPTSupplier export = new RPTSupplier();
            export.reportSupplier();
            ConnectionDB c = new ConnectionDB();
            c.closeConection();
        } catch (SQLException e) {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Reporte de proveedores");
